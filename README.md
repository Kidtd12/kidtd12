...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=220&text=Kidist%20Tadesse%20👩‍💻&fontAlign=50&fontAlignY=40&color=gradient&fontColor=ffffff&fontSize=50&desc=Web%20Developer%20|%20Full%20Stack%20|%20React%20%7C%20UI/UX&descAlignY=60&descAlign=50" />
</p>
...
⚡ Exploring MERN stack & creative UI designs  
💬 Ask me about React, JavaScript, CSS animations, responsive UI  
...
|-----------|----------------|---------|
| ▶️ YouTube Clone | Responsive video streaming app (React + YouTube API) | View Repo |
| 🎬 Netflix Clone | Movie streaming UI (React + TMDB API) | View Repo |
| 🌦️ Weather App | React weather app w/ live search (OpenWeather API) | View Repo |
